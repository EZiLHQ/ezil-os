 ...
 *
 * @typedef {'worker_unreachable' | 'sandbox_crashed' | 'desktop_unreachable' | 'timeout' | 'unknown'} BootFailureReason
 */

/**
 * @typedef {{ kind: 'failed', reason: BootFailureReason }} BootFailureState
 * @typedef {BootProgressState | BootReadyState | BootNotConfiguredState | BootFailureState} BootUiState
 */
