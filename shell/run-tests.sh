...
#
#       /data/openclaw/projects/ezil/EZiL-Universe/node_modules   playwright 1.61.1
#       /data/openclaw/projects/ezil/EBuilder/node_modules        playwright 1.59.1
#
...
Environment:
  PLAYWRIGHT_REQUIRE_DIR   directory from which the browser suites resolve
                           ...
                           /data/openclaw/projects/ezil/EZiL-Universe/node_modules
...
DEFAULT_PW_DIR="/data/openclaw/projects/ezil/EZiL-Universe/node_modules"
