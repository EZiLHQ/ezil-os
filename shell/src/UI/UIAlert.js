 ...
 */
// MODIFIED BY EZIL 2026-07-31: one added import. This file was expected to be
// verbatim, but it has a single cloud reference -- `puter.ui.closeDialog()` in
// the button-callback wrapper -- which upstream resolves from the globally
// injected Puter SDK. It now resolves to the rejecting stub, so that call
// logs and rejects after the user's callback has already run. Nothing else
// changed.

import UIWindow from './UIWindow.js';
import { puter } from '../ezil-stubs.js';
