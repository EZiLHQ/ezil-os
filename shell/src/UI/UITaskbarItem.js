...
// MODIFIED BY EZIL 2026-07-31: import block only. The body is byte-for-byte
// upstream. `launch_app` (upstream `helpers/launch_app.js`, 805 lines, backed
// by `puter.apps` + the un-ported IPC.js) now resolves to the rejecting stub in
// `../ezil-stubs.js`, so the four context-menu paths that used to launch an app
// -- New Window, Open Trash, and the two drag-drop-onto-an-app branches --
// fail loudly instead of appearing to work. Everything else here (tooltips,
// context menu, droppable, taskbar-position geometry) is local DOM work and is
// untouched.
