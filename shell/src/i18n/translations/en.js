 ...
 */
// MODIFIED BY EZIL 2026-07-31: replaced every user-visible occurrence of the
// Puter word mark and puter.com URLs with EZiL equivalents. Upstream's
// TRADEMARK.md requires a modified distribution to remove the marks, so this
// is a licence obligation, not branding. Dictionary KEYS are untouched --
// they are lookup identifiers, never rendered, and UIWindow.js's ~72 i18n()
...
const en = {
    ...
    dictionary: {
        ...
        from: 'From',
        general: 'General',
        get_a_copy_of_on_puter: 'Get a copy of \'%%\' on EZiL!',
        ...
        phone_verify_subtitle: "We'll text you a verification code to confirm it's really you.",
        phone_country_label: 'Country',
        phone_number_label: 'Phone number',
        phone_send_code: 'Send Code',
        phone_verify_btn: 'Verify Phone',
        phone_resend_code: 'Re-send code',
        ...
        phone_error_reference: 'If this keeps happening, email support@ezil.org and include this code: {{id}}',
        ...
        plural_suffix: 's',
        powered_by_puter_js: 'Powered by {{link=docs}}EZiL{{/link}}',
        preparing: 'Preparing...',
        ...
        puter_description: 'EZiL is a personal cloud desktop that keeps your workspace in one secure place, reachable from anywhere at any time.',
        ram: 'RAM',
        ...
        refer_friends_c2a: 'Invite a friend to EZiL.',
        refer_friends_social_media_c2a: 'Get started on EZiL!',
        refresh: 'Refresh',
        ...
        'Resources': 'Resources',
        restart_puter_confirm: 'Are you sure you want to restart EZiL?',
        restore: 'Restore',
        save: 'Save',
        ...
        keyboard_shortcuts_intro: 'Learn the most useful shortcuts for navigating EZiL faster.',
        ...
        sign_in: 'Sign in',
        sign_in_with_puter: 'Sign in with EZiL',
        sign_up: 'Sign Up',
        ...
        storage_puter_used: 'used by EZiL',
        'your_plan': 'Your Plan',
        ...
        tos_fineprint: 'By signing up, you agree to EZiL\'s {{link=terms}}Terms of Service{{/link}} and {{link=privacy}}Privacy Policy{{/link}}.',
        ...
        you_have_been_referred_to_puter_by_a_friend: 'You have been referred to EZiL by a friend!',
        zip: 'Zip',
        tar: 'Tar',
        ...
        'contact_support': 'Please contact support@ezil.org.',
        'contact_support_with_code': 'Please contact support@ezil.org and include this code: {{id}}.',
        ...
        create_token_message: 'Create a named token to use the EZiL API from scripts, CLIs, agents, and integrations. It can do anything you can through the API, but cannot change your password or email, or delete your account.',
        token_label: 'Label',
        ...
        shared_api_token_note: 'The app can use the EZiL API on your behalf, but cannot change your password or email, or delete your account. You can revoke it any time under Settings \u2192 Security \u2192 Manage sessions.',
